  ...
  return (
    <>
      ...
      <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
        <img className='w-48 rounded' src={albumData.image} alt={albumData.title || 'Album Cover'} />
      ...
      <hr />{
        songsData.map((item, index) => (
          <div className='grid grid-col-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff26] cursor-pointer'>
